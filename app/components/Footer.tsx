  ...
  return (
    <footer className="w-full">
      ...
      <div className="w-full flex flex-col gap-4">
        ...
        <nav className="w-full">
          <ul className="flex w-full rounded-[16px] border border-custom-gray-200 overflow-hidden bg-white">
            {[
              ...
              { label: "Email", href: "mailto:hey@emmah.xyz" },
        ...
        {/* Copyright box */}
        <div className="w-full rounded-[16px] border border-custom-gray-200 bg-white h-12 px-4 flex items-center justify-center">
